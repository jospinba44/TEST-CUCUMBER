Feature: Création d'un utilisateur
  ...
  Scenario: Création d'un utilisateur avec un email déjà utilisé
    Given un utilisateur avec l'email "olga@gmail.com" existe déjà
    When je soumets une demande de création d'utilisateur avec le nom "olga", le prénom "Nelly", et l'email "olga@gmail.com"
  ...
  Scenario: Création d'un nouvel utilisateur avec des informations valides
    ...
    And je devrais voir un utilisateur créé avec le nom "olga" et le prénom "Nelly"